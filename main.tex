...
\author[Sample \textit{et~al}.]{Sn\ae d\'{i}s Kristmundsd\'{o}ttir\,$^{\text{\sfb 1,}*}$, Brynja D. Sigurp\'{a}lsd\'{o}ttir\,$^{\text{\sfb 1,2}}$ Birte Kehr\,$^{\text{\sfb 1}}$} and Bjarni V. Halld\'{o}rsson\,$^{\text{\sfb 1,2}}$ 
